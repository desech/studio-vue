...
module.exports = {
  ...
  parseClassJsCode (js, file, css, JSDOM) {
    ...
    js = this.getCodeTemplate(js, body, css, JSDOM)
    return js
  },
  ...
  getCodeTemplate (js, body, css, JSDOM) {
    const html = ParseRender.getTemplateBlock(body, css, JSDOM)
