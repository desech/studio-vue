...
module.exports = {
  // data = { regex: {}, defaults: {} }
  injectOverrides (node, ref, overrides, data) {
    ...
    this.injectTag(node, ref, overrides, data)
    this.injectComponent(node, ref, overrides, data)
  },
